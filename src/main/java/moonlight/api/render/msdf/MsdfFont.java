package moonlight.api.render.msdf;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public MsdfFont.Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("moonlight", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public MsdfFont.Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("moonlight", "fonts/" + atlasFileName + ".png");
			return this;
		}
