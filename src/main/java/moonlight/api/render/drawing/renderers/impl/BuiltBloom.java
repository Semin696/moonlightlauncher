package moonlight.api.render.drawing.renderers.impl;
...
import moonlight.api.render.drawing.builders.states.QuadColorState;
import moonlight.api.render.drawing.builders.states.SizeState;
import moonlight.api.render.providers.ResourceProvider;
import moonlight.api.render.drawing.renderers.IRenderer;

public record BuiltBloom(
        SizeState size,
    ...
    private static final ShaderProgramKey BLOOM_SHADER_KEY = new ShaderProgramKey(ResourceProvider.getShaderIdentifier("bloom"),
    ...
    public void render(Matrix4f matrix, float x, float y, float z) {
        ...
        ShaderProgram shader = RenderSystem.setShader(BLOOM_SHADER_KEY);
